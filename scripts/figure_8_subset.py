...
if __name__ == '__main__':
    ...
    jsonfile = dir_path+'/figure_8.json'
    ...
    for iimetric,imetric in enumerate(metric_names):
        ...
        if (iplot+1)//2 == 2: # last row
            sub.set_xticklabels([ str2tex(ii,usetex=usetex) for ii in ['J','F','M','A','M','J','J','A','S','O','N','D'] ], minor=True)
